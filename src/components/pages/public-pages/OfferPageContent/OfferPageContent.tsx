...
import { DiscountModal } from '../PartnerOfferContent/DiscountModal/DiscountModal';
						...
						<div className="w-[589px] grow-0 shrink-0 basis-auto box-border pb-[11px]">
							<div className="w-[100.00%] box-border">
								...
								<div className="w-[100.00%] box-border mt-5">
									...
									>
										Шоколадница — одна из самых известных и любимых сетей кофеен в России, которая
										уже более 20 лет радует своих гостей уютной атмосферой, вкусным кофе и
										изысканными десертами. Это место, где каждый может насладиться качественными
										напитками, авторскими десертами и сытными блюдами в комфортной обстановке.
									</p>
								</div>
							</div>
							<div className="w-[100.00%] box-border mt-5">
