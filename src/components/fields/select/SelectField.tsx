    ...
    query === ''
      ...
      : options.filter((option) =>
        ...
        const handleChange = (selected: Option) => {
          ...
          if (onChange) {
            // Эмулируем нативное событие `HTMLSelectElement`
            const event = {
              target: {
                name,
                value: selected.value, // передаём строку, а не объект
              },
...
//   value?: Option | undefined;
//   name: string;
//   onChange?: (event: { target: { name: string; value: Option } }) => void;
//   width: number;
//   labelFontSize: number;
//   placeholder: string;
//   onBlur?: (event: React.FocusEvent<HTMLInputElement>) => void;
...
//         target: {
//           name,
//           value: selected,  // Передаем объект Option
//         }
//       });
//     }
//   };
