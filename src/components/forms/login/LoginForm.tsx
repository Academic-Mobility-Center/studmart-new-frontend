...
export default function LoginForm() {
    ...
    return (
      ...
      <div className="flex flex-col gap-1">
        <InputField label="Почта" placeholder="Example@gmail.com" name="email" value={formData.email} onChange={handleChange} />
      ...
      <p className="text-sm text-[#888888] underline self-end mt-[-10px] cursor-pointer" onClick={handleForgotPasswordClick} >Забыли пароль?</p>
