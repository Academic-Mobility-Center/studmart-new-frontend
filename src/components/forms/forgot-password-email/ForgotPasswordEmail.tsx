...
//                     )}
//                     {isSend && (<p className="text-[#032c28] text-sm font-medium mt-1">Письмо для сброса пароля будет отправлено на почту в ближайшее время</p>)}
//                 </div>
//                 <button type="button" className="w-full bg-[#8fe248] text-[#032c28] p-2 rounded-2xl mt-4 text-centered" onClick={handleSubmit}>
//                     Отправить
//                 </button>
//             </div>
//         </div>
