			...
			<div className="pt-[20px] ">
				...
				<div className={fieldsRowClasses}>
					<div className={inputContainerClasses}>
						...
						/>
						{errors.companyName && (
							<p className="text-red-600 text-sm font-medium">{errors.companyName}</p>
						)}
					</div>
					<div className={inputContainerClasses}>
						<InputField
				...
				<div className={fieldsRowClasses}>
					...
					<div className={inputContainerClasses}>
						...
						/>
						{errors.companyEmail && (
							<p className="text-red-600 text-sm font-medium">{errors.companyEmail}</p>
						)}
					</div>
				</div>
				<div className={fieldsRowClasses}>
					<div className={inputContainerClasses}>
						...
						/>
						{errors.industry && (
							<p className="text-red-600 text-sm font-medium">{errors.industry}</p>
						)}
					</div>
					<div className={inputContainerClasses}>
						<SelectField
