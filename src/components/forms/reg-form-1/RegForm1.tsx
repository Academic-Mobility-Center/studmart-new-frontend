        ...
        <form 
         ...
         >
            ...
            <div className="flex flex-col gap-1">
                <InputField label="Почта" placeholder="Example@gmail.com" onChange={handleChange} name="email" value={formData.email}/>
                {errors.email && <p className="text-red-600 text-sm font-medium mt-1">{errors.email}</p>}
            </div>
            <div className="flex flex-col gap-1">
                <PasswordField label="Пароль" placeholder="********" onChange={handleChange} name="password" value={formData.password}/>
                {errors.password && <p className="text-red-600 text-sm font-medium mt-1">{errors.password}</p>}
            </div>
            <div className="flex flex-col gap-1">
                <PasswordField label="Повторите пароль" placeholder="********" onChange={handleChange} name="confirmPassword" value={formData.confirmPassword}/>
