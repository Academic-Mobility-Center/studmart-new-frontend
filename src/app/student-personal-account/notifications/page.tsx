...
const NotificationsPage = () => {
	...
	const saveButtonClasses =
		'bg-[#8fe248] font-[Mulish] text-sm font-bold tracking-[0.42px] uppercase text-[#032c28] min-w-[548px] mt-5 h-12 block box-border grow-0 shrink-0 basis-auto rounded-[15px] border-[none]';
	...
	return (
		<div className="flex flex-col gap-[40px]">
			...
			>
				...
				<p className="font-[Mulish] text-[14px] text-[#032C28] mb-10">
