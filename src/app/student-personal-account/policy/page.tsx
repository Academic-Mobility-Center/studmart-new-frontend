...
import { categoriesAndServices, personalDataItems } from '../context';
import { ArrowDown } from './icons/ArrowDown';
import { ArrowUp } from './icons/ArrowUp';

const saveButtonClasses =
	'bg-[#EFEFEF] font-[Mulish] text-sm font-bold tracking-[0.42px] uppercase text-[#032c28] min-w-[548px] mt-5 h-12 block box-border grow-0 shrink-0 basis-auto rounded-[15px] border-[none]';
