		...
		<>
			<div className="flex flex-col gap-[40px]">
				...
				>
					...
					{issueRequestVisible && (
						<p className="text-[#888888] font-[Mulish] text-left mt-[10px]">
				...
				>
					...
					<div className="flex flex-col gap-4 mb-10">
						<p className="text-left font-[Mulish] text-[#032C28]">
					...
					<div className="flex flex-row gap-6 mb-5">
                        ...
                        grow-0 shrink-0 basis-auto rounded-[15px] border border-[rgba(0,0,0,0.20)]"
							...
							{copiedText === 'link' && (
								<p className="text-[#888888] font-[Mulish] text-sm ">Ссылка скопирована</p>
							)}
						</div>
						<div className="flex flex-col">
							<button
                        ...
                        grow-0 shrink-0 basis-auto rounded-[15px] min-w-[262px] border border-[rgba(0,0,0,0.20)]"
							...
							{copiedText === 'promocode' && (
								<p className="text-[#888888] font-[Mulish] text-sm ">Промокод скопирован</p>
							)}
						</div>
					</div>
				</div>
